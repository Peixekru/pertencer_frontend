<template>
    ...
    > 
        ...
        >
            ...
            <p class="my-4 text-center text-h6"><strong>Parabéns!</strong></p>
            <p class="px-4 mb-2 text-center">Você concluiu mais uma parte do Programa de Integração Einstein Pertencer.</p>
